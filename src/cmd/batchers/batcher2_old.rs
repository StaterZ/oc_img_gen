...
pub fn draw(renderer: &mut impl Renderer, frame: &Frame, prev_frame: Option<&Frame>) {
	...
	draw_batches_naive(renderer, batches);
}
...
fn draw_batches_naive<>(renderer: &mut impl Renderer, mut batches: Vec<Batch>) {
	...
	let mut state = RenderState {
		bg: PackedColor::new(PaletteOr::NonPalette(StaticColor::deflate(RGB8::new(0x000000)))), //arbitrary
		fg: PackedColor::new(PaletteOr::NonPalette(StaticColor::deflate(RGB8::new(0xffffff)))), //arbitrary
	};
